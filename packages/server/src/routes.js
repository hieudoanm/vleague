...
function RegisterRoutes(app) {
  ...
  app.get(
    '/api/users',
    ...(0, runtime_1.fetchMiddlewares)(users_controller_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(
      users_controller_1.UsersController.prototype.getUser
    ),
  ...
  app.post(
    ...
    ...(0, runtime_1.fetchMiddlewares)(users_controller_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(
      users_controller_1.UsersController.prototype.createUser
    ),
